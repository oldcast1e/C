...
// // #include  <string.h>
// // #include  <stdlib.h>
// // void roomslect(char room,int roomcode){
// //     if(room == 'p'){
// //         if(roomcode != 1) {printf("please input correctly");key = 1;}
// //         else if(strcmp(hotel[0],"0")==0){
// //         // printf("><");
// //             strcpy(hotel[0],name);
// //         }
// //         else{
...
// //     }
// //     else if(room == 's'){
// //         if(3<roomcode || roomcode <1) {printf("please input correctly");key = 1;}
// //         else if(strcmp(hotel[roomcode],"0")==0){
// //         // printf("><");
// //             strcpy(hotel[roomcode],name);
// //         }
// //         else{
// //             printf("please select another room");
// //             key = 1;
...
// //     else if(room == 'd'){
// //         if(6<roomcode || roomcode <1) {printf("please input correctly");key = 1;}
// //         else if(strcmp(hotel[roomcode+3],"0")==0){
// //         // printf("><");
// //             strcpy(hotel[roomcode+3],name);
// //         }
// //         else{
// //             printf("please select another room");
// //             key = 1;
...
// //     char room,tmp;//펜트하우스(p), 스위트룸(s), 디럭스룸(d)
// //     int roomcode;//객실유형별 방 번호 (숫자입력) - 펜트하우스(1), 스위트룸(1,2,3), 디럭스룸(1,2,3,4,5,6)
...
// //         if(tmp == '\n'){
// //             if(book == 'n') break;
// //             else printf("<>please input correctly");
// //         }
// //         else{
// //             scanf("%c %d",&room,&roomcode);
// //             getchar();
// //             gets(name);
// //             key = 0;
// //             if(book == 'n')break;
// //             else if(book != 'y' && book != 'c'){printf("please input correctly");key = 1;}
// //             else if(book == 'y'){
...
// //             else if(book == 'c'){
// //                 for(int i=0;i<10;i++){
// //                     if(strcmp(hotel[i],name)==0) strcpy(hotel[roomcode],"0\0");
...
//     for(int i=0;i<10;i++){
//                         if(strcmp(hotel[i],name)==0) strcpy(hotel[romcode],"0\0");
//                         if(room == 'p'){
//                         if(romcode != 1) {printf("please input correctly");key = 1;}
//                         else if(strcmp(hotel[0],"0")==0){
//                         // printf("><");
//                             strcpy(hotel[0],name);
//                         }
...
//                     }
//                     else if(room == 's'){
//                         if(3<romcode || romcode <1) {printf("please input correctly");key = 1;}
//                         else if(strcmp(hotel[romcode],"0")==0){
//                         // printf("><");
...
//                     else if(room == 'd'){
//                         if(6<romcode || romcode <1) {printf("please input correctly");key = 1;}
//                         else if(strcmp(hotel[romcode+3],"0")==0){
//                         // printf("><");
