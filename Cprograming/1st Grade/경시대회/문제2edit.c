...
int main(){
    ...
    char hotel[10][10]= {0};int key = 0 ,namekey;
    ...
    while (1){
        ...
        if(tmp == '\n'){
            ...
            if(book == 'n')break;
                ...
                for(int i=0;i<10;i++) if(strcmp(hotel[i],name)==0) namekey = 1;
                if(namekey == 1) {printf("please input another name");key = 1;}
                else if(room == 'p'){
                ...
                printf("\n");
                // for(int i=0;i<10;i++) printf("<%s> ",hotel[i]);printf("\n");
